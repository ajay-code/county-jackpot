<template>
    <div class="row featured-content">
        ...
        <div class=" featured-play col-lg-2 text-center">
            <a class="btn btn-primary btn-lg work-button2 featured-play-button" style="padding: 8px 1.5rem;" :href="`/county-draw/${lottery.parent_lottery_id}/buy`" role="button" @click="preventIfExpired" :disabled="remainingTime == 'End'">{{ remainingTime == 'End' ? 'Closed' : 'Buy Now' }}</a>
        </div>
    </div>
</template>
